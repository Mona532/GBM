"""Merge 16-type C2L results into h5ad obsm."""
import pandas as pd, numpy as np, anndata as ad
from pathlib import Path
import warnings; warnings.filterwarnings("ignore")

C2L = Path(r"E:/GBM/results/c2l_tls_v1")
H5AD_IN = Path(r"E:/GBM/spatial_data_visium/spatial_data_visium/anndata_consolidated")
H5AD_OUT = Path(r"E:/GBM/spatial_data_visium/spatial_data_visium/anndata_consolidated_tls16")
...
for c2l_dir in sorted(C2L.iterdir()):
    ...
    adata.write(H5AD_OUT / f"{sid}.h5ad", compression="gzip")

print(f"Done: {len(list(H5AD_OUT.glob('*.h5ad')))} h5ad files")
